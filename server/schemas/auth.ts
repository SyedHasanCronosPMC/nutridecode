...
export type ResetPasswordRequest = z.infer<typeof authSchemas.resetPassword>['body'];
export type ChangePasswordRequest = z.infer<typeof authSchemas.changePassword>['body'];